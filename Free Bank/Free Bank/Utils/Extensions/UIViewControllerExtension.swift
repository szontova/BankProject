...
extension UIViewController {
    ...
    func checkSignUpDatas(_ status: Int, _ name: String, _ email: String, _ login: String, _ password: String, _ repeatPassword: String) -> Bool {
        ...
        case 0:
            ...
            if !checkLogin(login: login) { return false }
            if findIndivididual(by: login) != nil {
        ...
        case 1:
            ...
            if !checkUNP(unp: login) { return false }
            if findOrganization(by: login) != nil {
    ...
    func showAlertError(message: String) {
        ...
        let attributedString = NSAttributedString(string: "Ошибка", attributes: [ NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15), NSAttributedString.Key.foregroundColor: UIColor.red
        ])
